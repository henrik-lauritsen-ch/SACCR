...
####################################################################################################
# Read base data
df = pd.read_csv('/Users/henriklauritsen/Documents/python/Saccr development/base_data_saccr.csv')
...
#df_result_eff.to_excel('/Users/henriklauritsen/Documents/python/Saccr development/' + file_name1)
#df_total_saccr.to_excel('/Users/henriklauritsen/Documents/python/Saccr development/' + file_name2)





#print(df.iloc[:, range(25, 40)])
#print(df)
#print(df_effective_notional)
#print(df_ir)
#df_add_on = df2.groupby(['Netting_Set', 'Asset_Type' ], as_index=False)['Market_Value', 'Collateral_Cover_Value', 'AdjustedNotional', 'Add_On_Corr', 'Add_On_1M_Corr'].sum()
#df_add_on['Add_On_AC'] = df_add_on.apply(lambda row: CalcAddOnAC(row['Add_On_Corr'], row['Add_On_1M_Corr']), axis=1)
#print(df.iloc[:,[2,3,4,5,6,7,8,20]])
#print(df.iloc[:,range(25,40)])
#print(df_efftive_notional)
#add_on = np.array([1,2,7])
